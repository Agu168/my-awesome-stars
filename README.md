...
*   [Peiiii/AgentVerse](https://github.com/Peiiii/AgentVerse) - Multi-Agent Collaboration  Platform✨
...
*   [YangZxi/Linkit](https://github.com/YangZxi/Linkit) - A lightweight file-sharing & image-hosting application: upload files -> pick a share code -> preview in the browser. (一个轻量级的文件分享&图床系统，上传文件 -> 获取分享码 -> 浏览器在线预览)
...
*   [dayflow-js/calendar](https://github.com/dayflow-js/calendar) - A lightweight and elegant React full calendar(or React-big-calendar) component for the web, easily integrated with shadcn-ui or any Tailwind-based UI library 🌟 Star if you like it!
...
*   [csupenn/TopFlow](https://github.com/csupenn/TopFlow) - TopFlow is a security-focused visual workflow builder for creating AI-powered applications.
...
*   [KeloYuan/Niki-AI](https://github.com/KeloYuan/Niki-AI) - 一个笔记软件的AI工具
...
*   [ceedaragents/cyrus](https://github.com/ceedaragents/cyrus) - Your Claude Code powered Linear agent that runs on any machine
...
*   [ZyphrZero/obsidian-smart-workflow](https://github.com/ZyphrZero/obsidian-smart-workflow) - AI tools & cross-platform terminal for Obsidian.
...
*   [sdrpsps/qr-manager](https://github.com/sdrpsps/qr-manager) - 一个基于 Next.js 开发的动态二维码生成工具🎉
...
*   [YUHAI0/fin-agent-desktop](https://github.com/YUHAI0/fin-agent-desktop) - Fin-Agent Desktop 是一款基于 Electron + Python 的智能金融助手桌面应用。它集成了强大的 LLM 能力和专业的金融数据分析工具，为您提供自然流畅的金融咨询与分析服务。
...
*   [Xieweikang123/ReFast](https://github.com/Xieweikang123/ReFast) - 基于 Tauri 2 的 Windows 快速启动器

*   [yeahhe365/Dual-AI-Chat](https://github.com/yeahhe365/Dual-AI-Chat) - 一个先进的聊天应用，演示了一种独特的对话范式：用户的查询首先由两个不同的人工智能角色进行辩论和提炼，然后才提供最终的综合答案。该项目利用 Google Gemini API 驱动一个逻辑型 AI (Cognito) 和一个怀疑型 AI (Muse)，它们协作生成更健壮、准确和经过严格审查的响应。
...
*   [discountry/ritmex-ai-trader](https://github.com/discountry/ritmex-ai-trader) -
...
*   [yeahhe365/Qwen3-ASR-Studio](https://github.com/yeahhe365/Qwen3-ASR-Studio) - A modern web UI for the Qwen ASR model, featuring audio recording, PWA support, Picture-in-Picture mode, and local caching for fast, accurate transcriptions.
...
*   [xyh9949/image-watermark](https://github.com/xyh9949/image-watermark) - 一款批量为图片增加水印的工具，使用Next.js开发，具有全屏水印（平铺模式）、图片水印、文字水印。完全免费开源
...
*   [glidea/one-balance](https://github.com/glidea/one-balance) - Make ai KEY rotation SMARTER and more SECURE; Cloudflare Worker; Gemini Balance; gpt-load; GPT Load; Lightweight alternate; Free API; OpenRouter Key \[拯救你的颈椎 - 数字健康工具：https://forcebreak.zenfeed.xyz]
...
*   [yangliu2060/clawdchat-analysis](https://github.com/yangliu2060/clawdchat-analysis) - ClawdChat - Moltbook 深度分析 Skill for Claude Code. 抓取和分析 AI agents 社交网络，挖掘核心问题和解决方案。
...
*   [zstmfhy/wechat-to-notebooklm](https://github.com/zstmfhy/wechat-to-notebooklm) -
...
*   [FoundDream/editorial-card-generator-skill](https://github.com/FoundDream/editorial-card-generator-skill) - Transform your content into stunning, magazine-style information graphics in seconds. Perfect for social media, presentations, and knowledge sharing.
...
*   [ZeroLu/awesome-nanobanana-pro](https://github.com/ZeroLu/awesome-nanobanana-pro) - 🚀 An awesome list of curated Nano Banana pro prompts and examples. Your go-to resource for mastering prompt engineering and exploring the creative potential of the Nano banana pro(Nano banana 2) AI image model.

*   [lmxxf/Agentic-Context-Engineering-OpenSource](https://github.com/lmxxf/Agentic-Context-Engineering-OpenSource) -
...
*   [OrzMiku/llm-study-mode-prompt](https://github.com/OrzMiku/llm-study-mode-prompt) - A study mode prompt for large language models
...
*   [langgptai/awesome-grok-prompts](https://github.com/langgptai/awesome-grok-prompts) - A comprehensive collection of advanced prompts engineered for Grok AI. Features optimized templates, strategies, and expert techniques to maximize Grok's potential across diverse applications.
...
*   [yangmyc/jsproxy](https://github.com/yangmyc/jsproxy) -
...
*   [jacob-bd/notebooklm-cli](https://github.com/jacob-bd/notebooklm-cli) -

*   [elliottzheng/NotebookLM2PPT](https://github.com/elliottzheng/NotebookLM2PPT) - 🚀从 PDF 到全可编辑 PPT 的智能转换工具，让 NotebookLM 的演示文稿真正为你所用。
...
*   [aahl/zai-tts2api](https://github.com/aahl/zai-tts2api) - 🗣️ ZAI/GLM TTS to OpenAI Speech API, 免费的语音合成API，支持克隆音色，基于智谱TTS

*   [Bwkyd/wexin-read-mcp](https://github.com/Bwkyd/wexin-read-mcp) - 能够让大模型阅读微信公众号文章，使用浏览器模拟绕过反爬虫。
...
*   [brokermr810/QuantDinger](https://github.com/brokermr810/QuantDinger) - AI-driven, local-first quantitative trading platform for research, backtesting and live execution. Python-native, privacy-first, open source.
...
*   [zstmfhy/annas-to-notebooklm](https://github.com/zstmfhy/annas-to-notebooklm) -
...
*   [iamzifei/wechat-article-publisher-skill](https://github.com/iamzifei/wechat-article-publisher-skill) - Claude Skill that publish on Wechat articles (微信公众号发布）

*   [xieyan110/Novel2Comic](https://github.com/xieyan110/Novel2Comic) -
...
*   [eddiehe99/xyzrank](https://github.com/eddiehe99/xyzrank) - 【播客中文榜】数据，包括热门节目、热门播客、新锐节目、新锐播客。

*   [cellinlab/xyzrank](https://github.com/cellinlab/xyzrank) - 【播客中文榜】数据，包括热门节目、热门播客、新锐节目、新锐播客。

*   [faryhuo/backtrader](https://github.com/faryhuo/backtrader) - A next-generation AI-powered algorithmic trading platform supporting strategy backtesting, live/paper trading, parameter optimization, and intelligent analysis.

*   [kay-ou/SimTradeLab](https://github.com/kay-ou/SimTradeLab) - SimTradeLab is an open-source backtesting framework inspired by PTrade’s event-driven architecture. It features a lightweight, modular design and full syntax compatibility, enabling seamless strategy development and validation.

*   [JiangZhihao123/llmalpha](https://github.com/JiangZhihao123/llmalpha) - LLM-driven autonomous cryptocurrency trading strategy research framework
...
*   [YUHAI0/fin-agent](https://github.com/YUHAI0/fin-agent) - Fin-Agent 是一个基于 DeepSeek 等大模型和 Tushare 金融数据的智能金融分析助手。它能够通过自然语言交互，帮助用户查询股票行情、分析财务数据、获取市场指标、选股筛选以及策略回测，并提供投资参考建议。
...
*   [acgurl/mori](https://github.com/acgurl/mori) - 用心陪伴，温暖相随 💕  Built with ❤️ using AgentScope
...
*   [zzw8550556/ec\_predict\_flow](https://github.com/zzw8550556/ec_predict_flow) - 事件合约预测工作流系统

*   [zhaoyangpp/LottoProphet](https://github.com/zhaoyangpp/LottoProphet) - LottoProphet是一款集预测、分析与可视化于一体的专业彩票数据应用。本软件融合深度学习与高级统计学原理，为用户提供全方位的彩票数据解决方案。
...
*   [wfnuser/OpenNof1](https://github.com/wfnuser/OpenNof1) - Your custom 24/7 AI trading agent. Inspired by nof1.ai

*   [aahl/mcp-aktools](https://github.com/aahl/mcp-aktools) - 📈 提供股票、加密货币的数据查询和分析功能MCP服务器
...
*   [lc2panda/AITradingSimulator](https://github.com/lc2panda/AITradingSimulator) - 基于大语言模型模拟的智能交易决策系统，支持自定义交易策略、实时市场数据、专业级绩效分析和实时交易大屏。
...
*   [Anning01/AIMedia](https://github.com/Anning01/AIMedia) - AIMedia 是一款自动抓取热点，AI创作文章，自动发布的集成软件。支持头条，小红书，公众号等
...
*   [liangdabiao/crewai\_stock\_analysis\_system](https://github.com/liangdabiao/crewai_stock_analysis_system) - 基于CrewAI框架构建的智能股票分析系统，利用多Agent协作和智能流程控制，提供全面的股票投资分析服务。  🚀 特性 :  智能股票分析 基于AI的多维度股票分析,  批量处理  高效的批量股票分析,  实时监控  股票价格和指标实时监控 , 预警系统  智能预警和通知,  Web界面 直观的Web管理界面

*   [SheenHalo/Book-video-generate](https://github.com/SheenHalo/Book-video-generate) - 一个自动化书籍推广视频生成工具，可以根据书名自动生成带有配音和字幕的短视频。

*   [pydantic/pydantic-ai](https://github.com/pydantic/pydantic-ai) - GenAI Agent Framework, the Pydantic way

*   [liangdabiao/autogen-financial-analysis](https://github.com/liangdabiao/autogen-financial-analysis) - 一个基于微软AutoGen框架的企业级金融分析系统，使用多Agent架构提供全面的财务分析、风险评估和量化投资分析功能。 核心功能: 多源数据收集 : 整合Yahoo Finance、Alpha Vantage、Quandl等多个金融数据源, 智能财务分析 : 基于AutoGen的多Agent协作分析, 风险评估 : VaR计算、压力测试、蒙特卡洛模拟, 量化分析 : 因子模型、投资组合优化、机器学习预测, 实时监控 : 系统性能监控和告警, 数据可视化 : 交互式图表和报告生成,
...
*   [2024baibai/crypto\_invest\_with\_ai](https://github.com/2024baibai/crypto_invest_with_ai) - 基于OpenAI的加密货币投资助手
...
*   [shenweiyan/Digital-Garden](https://github.com/shenweiyan/Digital-Garden) - 知识管理就像一个花园，需要精心培育和持续维护才能繁荣。这是一个 All in Discussions 的个人数字花园，没事写写文章，喜欢的话请点 Star，想订阅点 Watch。
...
*   [aki66938/XHS\_RS\_TOOLS](https://github.com/aki66938/XHS_RS_TOOLS) - xhs\_toolkit for rust
...
*   [0000005/WeChatAgent](https://github.com/0000005/WeChatAgent) - 你的另一个微信，这里的每个人都带着记忆，只为你而来。

*   [liu-ziting/ThinkFlowAI](https://github.com/liu-ziting/ThinkFlowAI) - ThinkFlow AI 是一个轻量级“从想法到结构化图谱”的工作台：输入一个核心想法，应用会把它扩展为可浏览的知识图谱（模块/子模块）。每个节点支持继续追问扩展、深挖详情，以及可选的配图生成。

*   [chatfire-AI/huobao-canvas](https://github.com/chatfire-AI/huobao-canvas) - 火宝无限画布；支持文生图，图生图，图生视频，多模型切换。兼容 openai标准格式
...
*   [geekjourneyx/md2wechat-skill](https://github.com/geekjourneyx/md2wechat-skill) -   用 Markdown 写公众号文章，一键转换为精美排版并自动上传到微信草稿箱。支持 AI 多主题样式和批量发布，让公众号写作像发朋友圈一样简单。https://md2wechat.cn
...
*   [alwaysday1/twitter-character-counter](https://github.com/alwaysday1/twitter-character-counter) -

*   [pmhw/XME](https://github.com/pmhw/XME) - XME - XhsMcpEelecton - 小红书 electron 多账号自动化工具 支持 MCP
...
*   [crazy0x70/GCP-Spot-Check](https://github.com/crazy0x70/GCP-Spot-Check) - 自动监控和维护 Google Cloud Platform Spot 实例运行状态的智能工具
...
*   [qingzhou-dev/push-server](https://github.com/qingzhou-dev/push-server) - 轻舟微信消息推送服务，免费的企业微信应用推送，可以将消息简单的推送到微信
...
*   [justhtmls/html-tools](https://github.com/justhtmls/html-tools) - 开源 HTML 工具集 - 轻量、整洁、免费、隐私、无需安装
...
*   [BalioFVFX/IP-Camera](https://github.com/BalioFVFX/IP-Camera) - Android app that turns your device into an IP Camera

*   [soga11/Cloudflare-2FA-Generator](https://github.com/soga11/Cloudflare-2FA-Generator) - 一个功能强大、界面精美的2FA cloudflare工具
...
*   [wquguru/llm-council-zenmux](https://github.com/wquguru/llm-council-zenmux) - LLM理事会：多个LLM共同协作，回答你最困难的问题
...
*   [taoAIGC/AICompare](https://github.com/taoAIGC/AICompare) - one click to open multi AI sites ｜ 一键打开多个 AI 站点，查看 AI 结果
...
*   [zombieyang/sd-ppp](https://github.com/zombieyang/sd-ppp) - A Photoshop AI plugin
...
*   [crzidea/doh](https://github.com/crzidea/doh) - Country-Aware DNS over HTTPS (DoH) Worker

*   [NodeBB/NodeBB](https://github.com/NodeBB/NodeBB) - Node.js based forum software built for the modern web

*   [abrclano/Meandering.Path](https://github.com/abrclano/Meandering.Path) - 一套自用的 Clash 分流规则与配置方案，采用预处理方式，适用 Clash for Windows、Clash Verge（verge-rev / nyanpasu）；还包含些许 Stash 的复写模块。
...
*   [flingjie/Agent-100-Days](https://github.com/flingjie/Agent-100-Days) - 100 天搞定 Agent 开发
...
*   [jiuhunwl/short\_videos](https://github.com/jiuhunwl/short_videos) - 支持平台:网易云，抖音，快手，小红书，汽水音乐，微博，bilibili，皮皮虾，皮皮搞笑等，支持短视频图集去水印
...
*   [Nicolas-Gong/koyeb](https://github.com/Nicolas-Gong/koyeb) - 某容器云部署Xray高性能代理服务

*   [lzyyauto/efb2w](https://github.com/lzyyauto/efb2w) -
